  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 to-slate-800 px-6">
      <motion.div
        ...
        className="max-w-xl w-full text-center bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl p-10 shadow-2xl"
      >
        {/* Icon */}
        <motion.div
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="flex items-center gap-2 border border-gray-500 text-gray-200 hover:bg-white/10 px-6 py-3 rounded-xl font-semibold transition"
          >
            <ArrowLeft size={20} />
            Go Back
          </motion.button>
