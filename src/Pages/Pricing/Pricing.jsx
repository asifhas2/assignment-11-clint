      ...
      <div className="flex flex-col md:flex-row gap-6 max-w-6xl w-full">
        ...
        >
          ...
          <div className="mt-8 space-y-5">
            ...
            <div className="flex gap-3">
              <FaCheck className="text-green-400 mt-1" />
              <p className="text-gray-200">Create basic lessons</p>
            </div>

            <div className="flex gap-3">
              <FaCheck className="text-green-400 mt-1" />
              <p className="text-gray-200">Ads included</p>
            </div>

            <div className="flex gap-3">
              <FaCheck className="text-green-400 mt-1" />
              <p className="text-gray-200">Limited bookmarks</p>
            </div>

            <div className="flex gap-3">
              <FaCheck className="text-green-400 mt-1" />
              <p className="text-gray-200">Public lessons only</p>
            </div>
            <div className="flex gap-3">
              <FaCheck className="text-green-400 mt-1" />
              <p className="text-gray-200">Basic profile</p>
            </div>
            <div className="flex gap-3">
              <FaCheck className="text-green-400 mt-1" />
              <p className="text-gray-200">Community access</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          {/* Glow */}
          <div className="absolute top-0 right-0 w-40 h-40 bg-base-100/10 blur-3xl rounded-full"></div>
          ...
          <button
            ...
            className="btn w-full rounded-full bg-gray-700 hover:bg-gray-600 border-none text-gray-300 h-14 text-lg"
          >
          ...
          <div className="mt-8 space-y-5">
            ...
            <div className="flex gap-3">
              <FaCheck className="text-green-400 mt-1" />
              <p className="text-gray-200">Create featured lessons</p>
            </div>

            <div className="flex gap-3">
              <FaCheck className="text-green-400 mt-1" />
              <p className="text-gray-200">Ad-free experience</p>
            </div>

            <div className="flex gap-3">
              <FaCheck className="text-green-400 mt-1" />
              <p className="text-gray-200">Unlimited bookmarks</p>
            </div>

            <div className="flex gap-3">
              <FaCheck className="text-green-400 mt-1" />
              <p className="text-gray-200">Private + public lessons</p>
            </div>
            <div className="flex gap-3">
              <FaCheck className="text-green-400 mt-1" />
              <p className="text-gray-200">Premium badge</p>
            </div>
            <div className="flex gap-3">
              <FaCheck className="text-green-400 mt-1" />
              <p className="text-gray-200">Private + public lessons</p>
            ...
            <div className="flex gap-3">
              <FaCheck className="text-green-400 mt-1" />
              <p className="text-gray-200">Analytics dashboard</p>
            </div>
            <div className="flex gap-3">
              <FaCheck className="text-green-400 mt-1" />
              <p className="text-gray-200">Early access features</p>
            </div>
            <div className="flex gap-3">
              <FaCheck className="text-green-400 mt-1" />
              <p className="text-gray-200">AI writing assistance</p>
            </div>
          </div>
        </motion.div>
      </div>
